...
git_folder_location='C:\Users\victo\Desktop\MlOpsDemo\mlopsv3root'   #replace with the local root folder location where you want to create the project folder
project_name=mlopsv3-sparse   #replace with your project name
github_org_name=MlOpsDemoVG   #replace with your github org name
project_template_github_url=https://github.com/VictorGlasser/mlops-v3   #replace with the url for the project template for your organization created in step 2.2, or leave for demo purposes
